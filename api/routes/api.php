...
Route::prefix('v1')->group(function () {
    ...
    Route::prefix('portal')->group(function () {
        ...
        Route::post('reconnect/check', [PortalController::class, 'reconnectCheck'])->middleware('throttle:30,1');
        Route::post('reconnect', [PortalController::class, 'reconnect'])->middleware('throttle:10,1');
